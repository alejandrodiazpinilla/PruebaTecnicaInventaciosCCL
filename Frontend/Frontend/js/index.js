...
function displayDataInTable(data) {
  ...
  data.forEach((item) => {
    ...
    row.innerHTML = `
        ...
        <td>${item.check}</td>
        <td>
          <a data-id="${item.id}" data-target-modal="modal-editar" class="btn btn-sm btn-success edit-btn" title="Editar Producto"> <i style="color: white" class="fe fe-edit"> Editar Producto</i></a>
        </td>
    `;
